...
// File change 2
    ...
    const handleSave = async (section: keyof About, section2: keyof About) => {
        ...
        try {
            ...
            if (about.id) {
                const response = await axios.put(`https://api.elitemediahouses.com/about_dashboard/${about.id}/`, formData, { headers });
    ...
    const handleSave3 = async (section1: keyof TeamMember, section2: keyof TeamMember, section3: keyof TeamMember, index: number,) => {
        ...
        try {
            ...
            if (teammembers.id) {
                const response = await axios.put(`https://api.elitemediahouses.com/team_member/${teammembers.id}/`, formData, { headers });
                console.log("About updated:", response.data);
            } else {
